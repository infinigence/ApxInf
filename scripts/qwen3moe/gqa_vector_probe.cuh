#pragma once
#include "../../crates/apxinf-cuda/kernels/custom/gqa_decode_mma.cuh"

template<int tile_tokens>
__global__ void gqa_decode_mma_vector_bf16_kernel(
  ...
  for(int tile=begin;tile<end;tile+=tile_tokens) {
    ...
    for(int i=threadIdx.x;i<tile_tokens*16;i+=256) {

...
from multimodal_scoring import score_multimodal
...
def score_cohort(
    ...
    *,
    ...
    for item in prepared:
        ...
        multimodal = score_multimodal(
            contract["multimodal_bonus"],
            submission.get("multimodal"),
        ...
        section_scores = {
            ...
            "multimodal_bonus": multimodal["points"],
        }
        base_score = sum(
        ...
        bonus_score = sum(
            section_scores[name]
            for name in ("context_bonus", "multi_request_bonus", "multimodal_bonus")
        )
        ...
        rendered_score = {
            ...
            "multimodal_bonus_details": multimodal,
            "reliability_details": {
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="append",
        default=[],
        help="Platform control such as vLLM; repeat when needed.",
    )
    parser.add_argument(
        "--profile",

...
namespace apxinf::cuda_new::cutlass_ops::fp8_dual_geglu_detail {
...
struct GeGluOperation : cutlass::epilogue::fusion::FusionOperation {
  using ElementOutput = apxinf::cuda_new::cutlass_ops::fp8_dual_geglu_detail::ElementOutput;
  using ElementCompute = apxinf::cuda_new::cutlass_ops::fp8_dual_geglu_detail::ElementCompute;
  using ElementSource = apxinf::cuda_new::cutlass_ops::fp8_dual_geglu_detail::ElementSource;
...
template <>
struct FusionCallbacksTraits<apxinf::cuda_new::cutlass_ops::fp8_dual_geglu_detail::GeGluEVT> {
  using DispatchPolicy = void;
  using Callbacks = apxinf::cuda_new::cutlass_ops::fp8_dual_geglu_detail::GeGluEVT;
  using Operation = apxinf::cuda_new::cutlass_ops::fp8_dual_geglu_detail::GeGluOperation;
